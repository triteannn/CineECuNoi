    ...
    public class SQLAnalizaRepo : ISqlRepo<Analiza>
    {
        public void Add(Analiza analiza)
        {
            using (var connection = Globals.GetDbConnection())
            {
                ...
                {
                    connection.Open();
                    var query = "INSERT INTO Analize(DataRecoltarii, Eritrocite, Hemoglobina, Hematocrit, VEM, HEM, CHEM, LatimeDistribEritrocit, Trombocite, VolumMediuTrombocitar, Trombocrit, LatimeDistribTrombocit, Leucocite, Granulocite, Limfocite, MID, NumarGranulocite, NumarLimfocite, NumarMID, Glicemie, ALT_TGP, Colesterol, ListaBoliDetectate) VALUES(@DataRecoltarii, @Eritrocite, @Hemoglobina, @Hematocrit, @VEM, @HEM, @CHEM, @LatimeDistribEritrocit, @Trombocite, @VolumMediuTrombocitar, @Trombocrit, @LatimeDistribTrombocit, @Leucocite, @Granulocite, @Limfocite, @MID, @NumarGranulocite, @NumarLimfocite, @NumarMID, @Glicemie, @ALT_TGP, @Colesterol, @ListaBoliDetectate)";
                    ...
                    var paramList = new List<SqlParameter> {
                        new SqlParameter("@DataRecoltarii", analiza.DataRecoltarii),
                        new SqlParameter("@Eritrocite", analiza.Eritrocite),
                        new SqlParameter("@Hemoglobina", analiza.Hemoglobina),
                        new SqlParameter("@Hematocrit", analiza.Hematocrit),
                        new SqlParameter("@VEM", analiza.VEM),
                        new SqlParameter("@HEM", analiza.HEM),
                        new SqlParameter("@CHEM", analiza.CHEM),
                        new SqlParameter("@LatimeDistribEritrocit", analiza.LatimeDistribEritrocit),
                        new SqlParameter("@Trombocite", analiza.Trombocite),
                        new SqlParameter("@VolumMediuTrombocitar", analiza.VolumMediuTrombocitar),
                        new SqlParameter("@Trombocrit", analiza.Trombocrit),
                        new SqlParameter("@LatimeDistribTrombocit", analiza.LatimeDistribTrombocit),
                        new SqlParameter("@Leucocite", analiza.Leucocite),
                        new SqlParameter("@Granulocite", analiza.Granulocite),
                        new SqlParameter("@Limfocite", analiza.Limfocite),
                        new SqlParameter("@MID", analiza.MID),
                        new SqlParameter("@NumarGranulocite", analiza.NumarGranulocite),
                        new SqlParameter("@NumarLimfocite", analiza.NumarLimfocite),
                        new SqlParameter("@NumarMID", analiza.NumarMID),
                        new SqlParameter("@Glicemie", analiza.Glicemie),
                        new SqlParameter("@ALT_TGP", analiza.ALT_TGP),
                        new SqlParameter("@Colesterol", analiza.Colesterol),
                        new SqlParameter("@ListaBoliDetectate", analiza.ListaBoliDetectate)
                    };
        ...
        public Analiza FindLastEntity()
        {
            using (var connection = Globals.GetDbConnection())
            {
                ...
                {
                    connection.Open();
                    var query = "select * from Analize where Id=(select max(Id) from Analize)";
